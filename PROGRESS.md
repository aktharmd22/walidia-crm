...
| 3 | Charter sales: enquiries, matching, proposals, bookings, cost sheets, invoices, payments, **the gate engine** | 🟡 In progress | Gate engine complete with 21 tests; end-to-end charter flow passing |
| 4 | Charter operations: checklists, crew, vendors, Charter Day, incidents, damage, deposits, P&L | Not started | Checklist tables already exist (the boarding gate reads them) |
| 5 | Brokerage: listings, matching, viewings, offers, surveys, transactions, handover | Not started | 6 gate rules seeded inactive, waiting for these tables |
...
| Check | Command | State |
|---|---|---|
| Tests | `vendor/bin/pest` | 107 passing |
